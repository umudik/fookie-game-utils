module.exports = async function (ctx) {
    ...
    await ctx.use(require("./rules/move_rule.js"))
    await ctx.use(require("./rules/move_inventory_type_check.js"))
    await ctx.use(require("./rules/logged_in_move_rule.js"))

    await ctx.use(require('./effects/do_item_type_events'))
    await ctx.use(require('./effects/organise_inventory'))
    await ctx.use(require('./effects/move_effect'))
